...
type Store interface {
	...
	Query(ctx context.Context, pg page.Page) ([]User, error)
...
// Query returns one page of users, newest first.
func (c *Core) Query(ctx context.Context, pg page.Page) ([]User, error) {
	us, err := c.store.Query(ctx, pg)
	if err != nil {
